...
try:
    ...
    from ..frontend.Files.selecteer_bestandslocatie import get_uploaded_file, read_csv_file
except ImportError:
    ...
    from frontend.Files.selecteer_bestandslocatie import get_uploaded_file, read_csv_file  # type: ignore
